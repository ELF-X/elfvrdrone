...
#define PIOS_ADC_PIN1_GPIO_PORT          GPIOG                   
#define PIOS_ADC_PIN1_GPIO_PIN           GPIO_Pin_8              
#define PIOS_ADC_PIN1_GPIO_CHANNEL       ADC_Channel_11
#define PIOS_ADC_PIN1_ADC                ADC2
#define PIOS_ADC_PIN1_ADC_NUMBER         1
#define PIOS_ADC_BATTERY_PIN			 3
